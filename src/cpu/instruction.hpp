...
class Instruction {
 public:
  ...
  constexpr u8 rs() const { return (m_word & 0b00000011'11100000'00000000'00000000) >> 21; }
  // Register target field [20:16]
  constexpr u8 rt() const { return (m_word & 0b00000000'00011111'00000000'00000000) >> 16; }
  // Register destination field [15:11]
  constexpr u8 rd() const { return (m_word & 0b00000000'00000000'11111000'00000000) >> 11; }

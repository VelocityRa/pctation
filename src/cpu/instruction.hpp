...
class Instruction {
 public:
  ...
  constexpr u16 imm20() const {
    return (m_word & 0b00000000'00001111'11111111'11111111) >> 0;
  }
  // Immediate 26 field [26:0]
  constexpr u16 imm26() const {
    return (m_word & 0b00000011'11111111'11111111'11111111) >> 0;
  }
